...
$(document).ready(function () {
    $.getJSON('/test-task-motosport/MarketStore.json', function (data) {
        ...
        $('.cars-list').append(`
                <div id="car-id-${car.id}" class="car-card">
                    <div class="car-poster">
                        <img src = "../test-task-motosport/images/cars/${car.src}" alt = "${car.src}" />
                    </div>
                    <div class="car-info">
                        <div class="d-flex">
...
$('.accordion-button').click(function () {
    $('.accordion-item').removeClass('active-accordion-button');
    ...
    if ($(this).hasClass("collapsed") === false) {
        ...
        $(this).parent().parent().toggleClass('active-accordion-button');
    };
});
...
$(".sort-param").on('click', function (e) {
    ...
    if ($(this).text() === "Mileage (ascending)") {
        carsStore.sort(function (a, b) {
    ...
    if ($(this).text() === "Mileage (descending)") {
        carsStore.sort(function (a, b) {
            const aPrise = a.mileage.split(' km');
            const bPrise = b.mileage.split(' km');
...
$('.accordion-item').on('click', function (e) {
    $(".accordion-item").removeClass("border-bottom-none");
    const selectDiv = parseInt($(this).attr("data-accardion-item")) - 1;

    if ($(".accordion-button").hasClass("active-accordion-button-color") === true) {
        $(this).addClass("border-bottom-none");
        $("div[data-accardion-item='" + selectDiv + "']").addClass("border-bottom-none");
    } else {
        $(".accordion-item").removeClass("border-bottom-none");
    }
});
